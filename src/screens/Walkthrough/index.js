...
const img1 = require('@assets/walkthrough1.png');
const img2 = require('@assets/walkthrough2.png');
const img3 = require('@assets/walkthrough3.png');
            ...
            <Carousel
              ...
              <View style={styles.slides}>
                <Card style={styles.content}>
                  <Image source={img1} style={styles.imageIcons} />
              ...
              <View style={styles.slides}>
                <Card style={styles.content}>
                  <Image source={img2} style={styles.imageIcons} />
              ...
              <View style={styles.slides}>
                <Card style={styles.content}>
                  <Image source={img3} style={styles.imageIcons} />
