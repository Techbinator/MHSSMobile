...
export default {
  ...
  // Button
  btnFontFamily: platform === 'ios' ? 'System' : 'Roboto_light',
  ...
  //Date Picker
  datePickerTextColor: '#1D1D26',
  datePickerBg: 'transparent',

  // Font
  DefaultFontSize: 16,
  fontFamily: platform === 'ios' ? 'System' : 'Roboto_light',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  inputSuccessBorderColor: '#50D2C2',
  ...
  subtitleColor: platform === 'ios' ? '#1D1D26' : '#fff',
  titleFontColor: platform === 'ios' ? '#1D1D26' : '#fff',
